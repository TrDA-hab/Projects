...
- Stepper drivers configuration tutorials:
 ...
 - Don't forget to customize the microstep (MS1/MS2/MS3) for your needs (see tutorials above). If you forget or incorrectly adjust the microstepping mode (MS1 / MS2 / MS3) you will get this effect [video](https://youtu.be/1llRwfUVu5Q)   
